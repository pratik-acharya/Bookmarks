...
import tech.pratikacharya.apps.bookmarks.api.BookmarkResource;
...
public class BookmarkResourceRestController {
    ...
    @Autowired
    BookmarkResourceRestController(BookmarkRepository bookmarkRepository,
